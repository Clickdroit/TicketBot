...
public class CommandManager extends ListenerAdapter {
    ...
    public CommandManager(BotContext ctx) {
        ...
        List<ICommand> commandList = List.of(
            ...
            new MassBanCommand(ctx.moderationLog()),
            new TempBanCommand(ctx.tempBanService(), ctx.moderationLog()),
            new TimeoutCommand(ctx.moderationLog()),
            new UntimeoutCommand(ctx.moderationLog()),
            new UnbanCommand(ctx.moderationLog()),
            new NoteCommand(ctx.staffNoteService()),
             new LogsCommand(ctx.warningService()),
            ...
            new HistoryCommand(ctx.warningService().getWarningStore(), ctx.staffNoteService().getStaffNoteStore()),
            ...
            new StatusCommand(),
            new WhoisCommand(ctx.levelService(), ctx.warningService(), ctx.ticketService()),
            new SayCommand(ctx.moderationLog()),
            new EmbedCommand(ctx.moderationLog()),
            new AnnounceCommand(ctx.moderationLog()),
            new DmCommand(ctx.moderationLog()),
            new BroadcastCommand(ctx.moderationLog()),
